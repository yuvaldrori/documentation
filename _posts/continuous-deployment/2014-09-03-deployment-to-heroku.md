...
## Related Content
On our blog you will find a full tutorial on how to [deploy a Rails app from GitHub to Heroku](http://blog.codeship.com/2013/09/26/how-to-deploy-a-ruby-on-rails-app-from-github-to-heroku.html).
