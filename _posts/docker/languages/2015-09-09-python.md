...
categories:
  - docker
---
In this article you will learn about setting up a Python based project on our Docker infrastructure. We will use nosetest for setting up the build, but the same works for any other test framework as well.
